                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index)
                      {
                        return PredictionTile(
                          ...
                          key: ValueKey<String>('prediction_$index'), // Use a unique identifier
                        );
                      },
...
class PredictionTile extends StatelessWidget 
{
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    ...
    String placeDetailsUrl = "https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&key=AIzaSyBtU2FHfCfSYtEecSik6GzIk153wDVlsfU";
